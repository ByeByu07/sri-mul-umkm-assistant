...
export const DeleteProduct = ({
    ...
    return (
        <Card className="max-w-lg border border-red-200 bg-gradient-to-r from-red-50 to-pink-50">
            <CardContent className="p-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-red-800">Produk Dihapus! ✅</h3>
                        <p className="text-xs text-red-600">Berhasil dihapus dari inventori</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                        <div className="space-y-1">
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium text-red-600">{formatCurrency(sellingPrice)}</span>
                            </div>
                            <div className="flex justify-between">
